...
public class RefactorMethodPython {
...
//        String refactor_idom_code_path=dir_jep+"/RefactoringIdioms/";
        ...
        String refactor_idom_code_path=dir_jep+"/lib/RefactoringIdioms/main.py";
...
//        https://stackoverflow.com/questions/3987041/run-function-from-the-command-line
        //String[] args1 = new String[] { "python3", python_path,"jave_get_code_pairs_parallel", filepath, idiom};
//        System.out.println("Data.interpreter_path: "+Data.interpreter_path);
        String[] args1 = new String[] { Data.interpreter_path, python_path,"jave_get_code_pairs_parallel", filepath, idiom};
...
//        String[] args1 = new String[] { python_path, "jave_main", filepath, idiom};
        String[] args1 = new String[] {Data.interpreter_path, python_path, "jave_main", filepath, idiom};
...
//        String[] args1 = new String[] { python_path, "jave_refactor_by_code_pairs_parallel", filepath, idiom, String.valueOf(indexlist)};
        String[] args1 = new String[] { Data.interpreter_path, python_path,"jave_refactor_by_code_pairs_parallel", filepath, idiom, String.valueOf(indexlist)};
